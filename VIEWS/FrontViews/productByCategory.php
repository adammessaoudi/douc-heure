...
$listeProduit = $produitC->showProductsByCategory($_GET["idCategorie"]);
                    ...
                    <div class="py-3">
                        ...
                        <ul class="list-group">
                            <?php foreach ($listeCategorie as $categorieC) : ?>
                                <li>
                                    <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category" href="productByCategory.php?idCategorie=<?PHP echo $categorieC['idCategorie']; ?>"> <?php echo $categorieC['nomCategorie']; ?>
                                        <span class="badge badge-primary badge-pill"><?php echo $produitC->countProductsByCategory($categorieC['idCategorie']) ?></span>
                                    </a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
